...
class UNet1(nn.Module):
    def __init__(self, num_classes, num_channels=64, grayscale=False):
...
class UNet2(nn.Module):
    ...
    def __init__(self, num_classes, num_channels=64, grayscale=False):
        ...
        self.enc5 = _EncoderBlock(num_channels*4, num_channels*4, dropout=True)
        self.enc6 = _EncoderBlock(num_channels*4, num_channels*8, dropout=True)
        self.center = _DecoderBlock(num_channels*8, num_channels*16, num_channels*8)
        self.dec6 = _DecoderBlock(num_channels*16, num_channels*8, num_channels*4, dropout=True)
        self.dec5 = _DecoderBlock(num_channels*8, num_channels*4, num_channels*4, dropout=True)
        self.dec4 = _DecoderBlock(num_channels*8, num_channels*4, num_channels*4, dropout=True)
        self.dec3 = _DecoderBlock(num_channels*8, num_channels*4, num_channels*2)
        self.dec2 = _DecoderBlock(num_channels*4, num_channels*2, num_channels)
        self.dec1 = nn.Sequential(
            nn.Conv2d(num_channels*2, num_channels, kernel_size=3),
