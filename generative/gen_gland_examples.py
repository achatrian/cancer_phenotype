...
if on_cluster():
    ...
    sys.path.append("/gpfs0/users/win/achatrian/cancer_phenotype/pix2pix_cyclegan")
else:
...
from generative.utils import save_images, TestOptions, img2segmap, segmap2img
from phenotyping.models import VAE, Discriminator
from phenotyping.gland_dataset import GTDataset
from pix2pix_cyclegan.data import CreateDataLoader
...
def main(opts):
    ...
    print("Loaded settings of old model - ngf: {}, ndf: {}, nz: {}".format(opts.num_filt_gen,
                                                                           opts.num_filt_discr,
                                                                           opts.num_lat_dim))
    num_channels = 4
