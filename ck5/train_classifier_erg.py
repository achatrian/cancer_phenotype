...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--data_file', type=str, default="/gpfs0/users/win/achatrian/cancer_phenotype/ck5/glands_ERGlabel.csv")
    ...
    if on_cluster():
        ckpt_path = "/well/win/users/achatrian/cancer_phenotype/logs/" + "erg_" + timestamp + "/ckpt"
    else:
