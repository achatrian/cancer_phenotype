 ...
 *
 * @author Pete Bankhead, Korsuk Sirinukunwattana
 */
...
def downsample = 1.0 // !!!!!!!!! Our patches will already be downsampled, so keep this to 1.0
...
//
    ...
    // }
    // Export the mask
    def fileMask = new File(pathOutput, name + '.png')
