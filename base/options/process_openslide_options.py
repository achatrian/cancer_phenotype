...
class ProcessOpenSlideOptions(BaseOptions):
    def __init__(self):
        ...
        parser.add_argument('--image_suffix', type=str, default=['tiff'], action='append', choices=['tiff', 'svs', 'ndpi'], help="process images with these extension")
        ...
        parser.add_argument('--tissue_mask_dirname', type=str, default='foreground_extraction_expanded')
        ...
        if __debug__:
            parser.add_argument('-ds', '--debug_slide', type=str, action='append', help='only process slides with specified ids. Useful for debugging')
        # WSIReader options
