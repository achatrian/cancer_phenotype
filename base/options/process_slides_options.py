...
class ProcessSlidesOptions(BaseOptions):
    def __init__(self):
        ...
        parser.add_argument('--no_tissue_mask', action='store_true', help="Process slides even though tissue masks are not available for selected dataset")
        ...
        parser.add_argument('--cases_list_path', type=str, default=None, help="Path to file containing subset of cases ids to process")
        parser.add_argument('--slides_list_path', type=str, default=None, help="Path to file containing subset of slides ids to process")
        parser.add_argument('--max_size_annotation_area', type=int, default=50000**2)
