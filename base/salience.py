...
if __name__ == '__main__':
    ...
    save_dir = Path(opt.checkpoints_dir)/opt.experiment_name/'saliency_maps'
    ...
    counter = 0
    print(f"Start backpropagating on {sum(len(to_backprop[k]) for k in to_backprop)} tiles from {len(to_backprop)} slides ...")
