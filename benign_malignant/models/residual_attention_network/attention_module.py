...
class AttentionModule_pre(nn.Module):
    ...
    def forward(self, x):
        ...
        self.attention_map = out_softmax6.detach().cpu().numpy()
...
class AttentionModule_stage0(nn.Module):
    ...
    def forward(self, x):
        ...
        self.attention_map = out_softmax8.detach().cpu().numpy()
...
class AttentionModule_stage2(nn.Module):
    ...
    def forward(self, x):
        ...
        self.attention_map = out_softmax4.detach().cpu().numpy()
...
class AttentionModule_stage3(nn.Module):
    ...
    def forward(self, x):
        ...
        self.attention_map = out_softmax2.detach().cpu().numpy()
