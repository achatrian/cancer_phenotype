...
from repo_old.ck5.ck5_dataset import CK5AugmentStudyDataset
from repo_old.ck5.ck5_utils import eval_classification, DiceLoss
from repo_old.ck5.eval_ck5_net import test
...
if __name__ == '__main__':
    ...
    if on_cluster():
        ckpt_path = "/well/rittscher/users/achatrian/cancer_phenotype/logs/" + "ck5_aug_" + timestamp + "/ckpt"
    else:
