...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--input_nc', type=int, default=3, help='# of input images channels')
        parser.add_argument('--output_nc', type=int, default=3, help='# of output images channels')
        ...
        parser.add_argument('--Atype', type=str, default='images', help='chooses whether A images should be split into different channels (for segmentation) [images|seg_map]')
        ...
        parser.add_argument('--sequential_samples', action='store_true', help='if true, takes images in order to make batches, otherwise takes them randomly')
