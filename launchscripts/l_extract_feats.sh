...
SEG_MODEL=/well/win/users/achatrian/ProstateCancer/logs/2018_09_19_11_24_46/ckpt/epoch_.411_loss_0.20396_acc_0.95000_dice_0.93000_lr_0.0000103566.pth
NF=36
BS=$1
AUG=$2
WORKS=$3
...
echo "Start"
python /users/win/achatrian/ProstateCancer/phenotyping/extract_feats_unet.py -d $DATA_DIR --gpu_ids 0 1 \
