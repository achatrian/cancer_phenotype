...
import dzi_io.dzi_io as dzi_io
import utils


class TileGenerator(dzi_io.DZI_IO):
    '''
    ...
    def masked_percent(self, x, y, tile_mask_width, tile_mask_height):
        ...
        '''
        x, y, tile_mask_width, tile_mask_height = int(x), int(y), int(tile_mask_width), int(tile_mask_height)
