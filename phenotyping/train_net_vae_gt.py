...
from torch.nn import DataParallel, L1Loss, BCELoss, parallel
...
from phenotyping.gland_dataset import GTDataset
from phenotyping.models import VAE, Discriminator, weights_init
from segment.utils import get_time_stamp, check_mkdir, str2bool, evaluate_multilabel, colorize, \
    AverageMeter, get_flags
from segment.clr import CyclicLR

cudnn.benchmark = True

timestamp = get_time_stamp()
ckpt_path = "/well/win/users/achatrian/cancer_phenotype/logs/" + "gtvae" + timestamp + "/ckpt" if on_cluster() \
...
def main(FLAGS):
    ...
    if FLAGS.snapshot:
        ...
        try:
            ...
            print("Loaded settings of old model - ngf: {}, ndf: {}, nz: {}".format(FLAGS.num_filt_gen,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--data_dir', type=str, default="/gpfs0/well/win/users/achatrian/cancer_phenotype/Dataset/pix2pix/AB")
